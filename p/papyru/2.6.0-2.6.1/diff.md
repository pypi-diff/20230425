# Comparing `tmp/papyru-2.6.0.tar.gz` & `tmp/papyru-2.6.1.tar.gz`
...
### Comparing `papyru-2.6.0/papyru/varspool/command/__init__.py` & `papyru-2.6.1/papyru/varspool/command/__init__.py`
