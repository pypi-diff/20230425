# Comparing `tmp/airgiant-0.0.8.tar.gz` & `tmp/airgiant-0.0.9.tar.gz`
...
## Comparing `airgiant-0.0.8.tar` & `airgiant-0.0.9.tar`
...
### Comparing `airgiant-0.0.8/LICENSE` & `airgiant-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `airgiant-0.0.8/PKG-INFO` & `airgiant-0.0.9/PKG-INFO`
...
### Comparing `airgiant-0.0.8/pyproject.toml` & `airgiant-0.0.9/pyproject.toml`
...
### Comparing `airgiant-0.0.8/src/airgiant.egg-info/PKG-INFO` & `airgiant-0.0.9/src/airgiant.egg-info/PKG-INFO`
